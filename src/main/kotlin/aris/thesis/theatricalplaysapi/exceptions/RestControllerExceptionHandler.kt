...
class RestControllerExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    override fun handleExceptionInternal(ex: Exception, body: Any?, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val responseBody = if (body is RestResponse) {
            ...
            createErrorResponse(status, "Exception: ${ex.javaClass.name}." +
                    "\nMessage:${ex.message}.")
        }
    ...
    override fun handleBindException(ex: BindException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: BindException. " +
    ...
    override fun handleMissingPathVariable(ex: MissingPathVariableException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: MissingPathVariableException." +
    ...
    override fun handleMissingServletRequestPart(ex: MissingServletRequestPartException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: MissingServletRequestPartException. " +
    ...
    override fun handleMissingServletRequestParameter(ex: MissingServletRequestParameterException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: MissingServletRequestParameterException. " +
    ...
    fun handleConstraintViolation(ex: ConstraintViolationException, request: WebRequest): ResponseEntity<Any> {
        ...
        for (violation in ex.constraintName) {
            errors.append("\n")
                .append(violation.javaClass.name )
        }

        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: ConstrainViolationException. " +
    ...
    override fun handleTypeMismatch(ex: TypeMismatchException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: TypeMismatchException. " +
    ...
    fun handleMethodArgumentTypeMismatch(ex: MethodArgumentTypeMismatchException, request: WebRequest): ResponseEntity<Any> {
        ...
        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: MethodArgumentTypeMismatchException. " +
    ...
    override fun handleNoHandlerFoundException(ex: NoHandlerFoundException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: NoHandlerFoundException. " +
    ...
    override fun handleHttpRequestMethodNotSupported(ex: HttpRequestMethodNotSupportedException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: HttpRequestMethodNotSupportedException. " +
    ...
    override fun handleHttpMediaTypeNotSupported(ex: HttpMediaTypeNotSupportedException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: HttpMediaTypeNotSupportedException. " +
    ...
    override fun handleHttpMessageNotReadable(ex: HttpMessageNotReadableException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: HttpMessageNotReadableException. " +
    ...
    override fun handleMethodArgumentNotValid(ex: MethodArgumentNotValidException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val status = HttpStatus.BAD_REQUEST
        val error = createErrorResponse(status, "Exception: MethodArgumentNotValidException. " +
    ...
    override fun handleHttpMediaTypeNotAcceptable(ex: HttpMediaTypeNotAcceptableException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val status = HttpStatus.UNSUPPORTED_MEDIA_TYPE
        val error = createErrorResponse(status, "Exception: HttpMediaTypeNotAcceptableException. " +
    ...
    override fun handleHttpMessageNotWritable(ex: HttpMessageNotWritableException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        ...
        val error = createErrorResponse(status, "Exception: HttpMessageNotWritableException. " +
    ...
    override fun handleServletRequestBindingException(ex: ServletRequestBindingException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val error = createErrorResponse(status, "Exception: ServletRequestBindingException. " +
    ...
    override fun handleAsyncRequestTimeoutException(ex: AsyncRequestTimeoutException, headers: HttpHeaders, status: HttpStatus, webRequest: WebRequest): ResponseEntity<Any>? {
        val error = createErrorResponse(status, "Exception: AsyncRequestTimeoutException. " +
    ...
    override fun handleConversionNotSupported(ex: ConversionNotSupportedException, headers: HttpHeaders, status: HttpStatus, request: WebRequest): ResponseEntity<Any> {
        val error = createErrorResponse(status, "Exception: ConversionNotSupportedException. " +
...
//    fun handleSQLConstraintViolationException(ex: org.hibernate.exception.ConstraintViolationException, request: WebRequest): ResponseEntity<Any> {
//        //org.hibernate.exception.ConstraintViolationException
//        val status = HttpStatus.BAD_REQUEST
//        val error = createErrorResponse(status, "Exception: ConstraintViolationException. " +
...
//    }
    ...
    fun handleSQLDataException(ex: DataException, request: WebRequest): ResponseEntity<Any> {
        ...
        val status = HttpStatus.UNPROCESSABLE_ENTITY
        val error = createErrorResponse(status, "Exception: DataException. " +
    ...
    fun handleSQLGenericJDBCException(ex: GenericJDBCException, request: WebRequest): ResponseEntity<Any> {
        ...
        val status = HttpStatus.INTERNAL_SERVER_ERROR
        val error = createErrorResponse(status, "Exception: GenericJDBCException. " +
